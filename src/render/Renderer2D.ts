...
export class Renderer2D {
    ...
    static init() {
        ...
        Font.defaultFont = new Font('../src/render/data/defaultFont.png', defaultFontData);
        ...
        // Quads
        Render2DData.QuadShader = new Shader(Shader.quadShaderPath);
        ...
        // Lines
        Render2DData.LineShader = new Shader(Shader.lineShaderPath);
        ...
        // Circles
        Render2DData.CircleShader = new Shader(Shader.circleShaderPath);
